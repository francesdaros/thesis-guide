...
\section{Abstract, Lists, et al.}

Lists are maneged automatically. To updated the abstract, complete the \textsf{doc/abstract.tex} file.
...
\textsf{authorsdeclatationpage} in the \textsf{.cls} file and updated the related \textsf{file}.
